...
<div class="wrap js-check-wrap">
    ...
    <table class="table table-hover table-bordered">
        ...
        <tr>
        	...
        	<td>{$v.count}</td>
        	<td>{$v.status}</td>
        	<td><?php if($isRole){?><a href="<?php echo Url('category/role',array('id'=>$v['id']))?>">权限设置</a>&nbsp;&nbsp;|&nbsp;&nbsp;<?php } ?><a href="<?php echo Url('category/edit',array('id'=>$v['id'],'parent_id'=>$v['parent_id']))?>">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;删除</td>
        </tr>
        <?php } ?>
        </tbody>
     </table>
