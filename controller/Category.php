...
class Category extends Base
{
	...
	public function __construct($request){
		...
		$this->MEDIAMANAGE_role_table_name = Config::get("MEDIAMANAGE_role_table_name");
		$this->MEDIAMANAGE_role_name = Config::get("MEDIAMANAGE_role_name");
		$this->MEDIAMANAGE_role_id = Config::get("MEDIAMANAGE_role_id");
		
		$this->MEDIAMANAGE_admin_table_name = Config::get("MEDIAMANAGE_admin_table_name");
		$this->MEDIAMANAGE_admin_role = Config::get("MEDIAMANAGE_admin_role");
	...
	public function Edit(){
		...
		if($this->request->isPost()){
			...
			if($res["status"]){
				return [MEDIAMANAGE_VIEW_PATH.'category/edit.php',array_merge($this->data,['list'=>$res['info']])];
			}else{
				return ['code'=>0,'msg'=>$res['info']];
			}
		}
